          ...
          <div className="text-center md:text-left">
            ...
            <ul className="list-none p-0 m-0 space-y-3 mb-6">
              <li className="flex items-center justify-center md:justify-start gap-2">
                ...
                <a href={`mailto:${email}`} className="text-white hover:text-(--color-roti) transition-colors text-sm underline">
                  {email}
                </a>
              </li>
              <li className="flex items-center justify-center md:justify-start gap-2">
            ...
            <div className="flex gap-3 justify-center md:justify-start">
              ...
              <a href={socialLinks?.instagram || 'https://www.instagram.com/itsflowinfaith/'} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border-2 border-white flex items-center justify-center hover:bg-white hover:text-(--color-primary) transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href={socialLinks?.youtube || 'https://www.youtube.com/@ItsFlowinFaith'} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border-2 border-white flex items-center justify-center hover:bg-white hover:text-(--color-primary) transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" />
                </svg>
              </a>
              <a href={socialLinks?.tiktok || 'https://www.tiktok.com/@itsflowinfaith'} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border-2 border-white flex items-center justify-center hover:bg-white hover:text-(--color-primary) transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
