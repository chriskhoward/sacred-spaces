  ...
  return (
    <>
      ...
      <HeroBlock
        ...
        subtitle="Step into a faith-affirming, culturally grounded community designed to support Christian Yoga Teachers of Color in growing confidently, connecting deeply, and leading boldly in their calling."
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl lg:text-6xl font-bold text-(--color-primary) mb-16 text-center leading-tight">
              What if you could….
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white p-10 rounded-[3rem_0_3rem_0] shadow-[0_10px_40px_rgba(0,0,0,0.08)] hover:shadow-[0_20px_60px_rgba(0,0,0,0.12)] transition-all group border-2 border-transparent hover:border-(--color-sidecar) hover:-translate-y-2">
                <div className="w-20 h-20 bg-(--color-sidecar) text-4xl flex items-center justify-center rounded-2xl mb-8 group-hover:scale-110 group-hover:bg-(--color-roti) transition-transform">
                  ✨
                </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="bg-white p-12 md:p-16 rounded-[4rem_0_4rem_0] shadow-[0_20px_60px_rgba(0,0,0,0.1)] border-l-4 border-(--color-roti)">
              <h2 className="text-4xl lg:text-5xl font-bold text-(--color-primary) mb-10 text-center">
                Listen, I see you…
              </h2>
              <div className="space-y-8 text-lg text-gray-700 leading-relaxed">
                ...
                <div className="flex gap-4">
                  <div className="flex-shrink-0 w-2 h-2 rounded-full bg-(--color-roti) mt-3"></div>
                  <p>
                    AND even though you&apos;ve done the trainings, attended the workshops, and connected with people along the way, there&apos;s still a quiet loneliness. Because so few truly understand what it means to be a Christian Yoga Teacher of Color navigating multiple worlds at once.
                  </p>
                </div>
                <div className="flex gap-4">
                  <div className="flex-shrink-0 w-2 h-2 rounded-full bg-(--color-roti) mt-3"></div>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-4xl lg:text-5xl font-bold text-(--color-primary) mb-16 text-center">
              You don&apos;t have to…
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto text-center">
            <div className="bg-white p-12 md:p-16 rounded-[4rem_0_4rem_0] shadow-[0_20px_60px_rgba(0,0,0,0.1)] border-2 border-(--color-sidecar)">
              <h2 className="text-4xl lg:text-6xl font-bold text-(--color-primary) mb-6">
                INTRODUCING…
              </h2>
              <h3 className="text-3xl lg:text-5xl font-bold text-(--color-primary) mb-6">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
              <div className="bg-white p-10 rounded-[3rem_0_3rem_0] shadow-[0_10px_40px_rgba(0,0,0,0.08)] hover:shadow-[0_20px_60px_rgba(0,0,0,0.15)] transition-all group border-2 border-transparent hover:border-(--color-sidecar) hover:-translate-y-2">
                <div className="w-16 h-16 bg-(--color-sidecar) text-3xl flex items-center justify-center rounded-2xl mb-6 group-hover:scale-110 group-hover:bg-(--color-roti) transition-transform">
                  📋
                </div>
                <h4 className="text-2xl font-bold text-(--color-primary) mb-4">TEACHER DIRECTORY PLACEMENT</h4>
                <p className="text-gray-700 leading-relaxed">
                  Visibility through our publicly accessible directory so students, churches, and organizations can find and hire Christian Yoga Teachers of Color worldwide.
                </p>
              </div>
            ...
            <div className="bg-gradient-to-br from-(--color-sidecar) to-white p-12 md:p-16 rounded-[4rem_0_4rem_0] shadow-[0_20px_60px_rgba(0,0,0,0.1)] border-2 border-(--color-roti)/20 mb-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="bg-white/80 p-8 rounded-[2rem_0_2rem_0] shadow-lg backdrop-blur-sm">
                  <div className="w-14 h-14 bg-(--color-roti) text-2xl flex items-center justify-center rounded-xl mb-4 text-white">
                    📢
                  </div>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-5xl font-bold text-(--color-primary) mb-8 text-center">
              MEET THE VISIONARIES
            </h2>
            <p className="text-xl text-gray-700 mb-16 text-center max-w-3xl mx-auto leading-relaxed">
              Led by Queen and De, the Flow in Faith Teachers Collective was created from lived experience, prayerful discernment, and a deep belief that Christian Yoga Teachers of Color were never meant to walk this calling alone.
            </p>
            <div className="bg-(--color-gallery) p-12 rounded-[3rem_0_3rem_0] mb-16 text-center border-2 border-(--color-sidecar)">
              <p className="text-gray-600 italic text-lg">Enter Video here</p>
            </div>
        ...
        items={[
          {
            ...
            answer: "The Flow in Faith Teachers Collective is for yoga teachers of color who identify as Christian and are seeking a culturally aware, faith-affirming community where they can grow, teach, and be poured into as whole people. It's especially supportive for those navigating the tension between the yoga world, the church world, and their own desire to teach authentically without overextending, overexplaining, or shrinking."
          },
          {
          ...
          },
          {
            ...
            answer: "Flow in Faith Teachers Collective is the only space intentionally created for Christian Yoga Teachers of Color where faith, culture, and calling are honored together without compromise. Our difference lies in culturally grounded community, spiritually aligned growth, and leadership rooted in lived experience."
          },
          {
