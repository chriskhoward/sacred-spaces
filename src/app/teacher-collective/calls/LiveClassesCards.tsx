...
export default function LiveClassesCards({ classes, userTier }: LiveClassesCardsProps) {
          ...
          >
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6">
                This live session is available to Core and Pro members. Upgrade your membership to join.
              </p>
