...
export default function CommunityClient() {
    ...
    return (
        <div className="max-w-3xl mx-auto">
            ...
            {/* Why Join Section */}
            <section className={`transition-all duration-700 delay-100 ${agreed ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4 pointer-events-none'}`}>
                <div className="bg-white p-10 md:p-12 rounded-3xl shadow-xl text-center border border-gray-100">
                    ...
                    <h2 className="text-3xl font-bold text-(--color-primary) mb-4">Connect on WhatsApp</h2>
                    <p className="text-gray-600 text-lg mb-8 max-w-xl mx-auto">
                        Our community lives on WhatsApp! Connect with fellow teachers and practitioners in real time, share inspiration, and stay updated.
                    </p>
                    <a
                        href="https://chat.whatsapp.com/IUiYAER2VWW0OnFPoZwLmZ?mode=gi_t"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-3 px-8 py-4 bg-green-500 text-white font-bold rounded-full hover:bg-green-600 transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5"
                    >
                        Join the WhatsApp Group
                    </a>
                </div>
