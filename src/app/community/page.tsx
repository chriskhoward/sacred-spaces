          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-white p-10 md:p-12 rounded-lg shadow-xl text-center">
              ...
              <a
                ...
                className="inline-flex items-center gap-3 px-10 py-5 bg-green-500 text-white font-bold text-lg rounded-full hover:bg-green-600 transition-colors shadow-lg hover:shadow-xl hover:-translate-y-0.5 transform transition-all"
              >
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="mt-12 p-8 bg-(--color-primary) rounded-lg text-center text-white">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 px-8 py-4 bg-(--color-roti) text-white font-bold rounded-full hover:opacity-90 transition-opacity"
              >
